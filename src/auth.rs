...
impl AuthenticationFlow {
    ...
    pub fn initiate_authentication(&mut self, user_id: String, _reply_address: String) -> String {
        let _session = self
            .session_manager
            .create_session(user_id.clone(), _reply_address);
    ...
    pub fn verify_signed_message(
        ...
        if let Some(signature) = &signed_message.signature {
            if signature == expected_signature {
                return self
                    .session_manager
                    .authenticate_session(&signed_message.sender_address);
            }
        }
        false
    }
    ...
    pub fn create_signed_command(
        ...
        let _reply_address = self
            .session_manager
            .get_reply_address(user_id)
...
mod tests {
    ...
    fn test_authentication_flow() {
        ...
        let challenge =
            auth.initiate_authentication("zs1user123".to_string(), "zs1reply456".to_string());
